    ...
    <div class="container">
        <div class="row-fluid content-inner">
            <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                ...
                <div class="content">
    <div class="avatar">
        <i class="icon-camera-retro" title="In New York"></i>
    </div>
    <div class="blog-post-body section">
        <div class="controls">
    <span class="date-text"> ${article.published_date}</span>
</div>
<div class="heading">
...
<div class="content">
    ...
    <div class="image">
            <a data-ss="imagemodal" data-href="./home_files/${article.image}" rel="group" title="Claritas est etiam processus dynamicus, qui sequitur" has-arrows="False"><img src="./home_files/${article.image}"></a>
    </div>
        <div class="image-caption">
        <p class="sub2">${article.content}</p>
    </div> 
</div>
    ...
    <ul class="pager">
        <li><a href="http://us-123fashion.simplesite.com/410906719?overview=1">Overview</a></li>
    </ul>
</div>
