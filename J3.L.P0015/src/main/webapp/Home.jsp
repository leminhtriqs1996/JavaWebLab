<%-- 
    Document   : Home
    Created on : Oct 28, 2019, 9:07:47 PM
    Author     : aaa
--%>

<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<jsp:useBean id="productDAO" class="dao.ProductDAOImpl"> </jsp:useBean>
<!DOCTYPE html>
<!DOCTYPE html>
...
<meta property="og:url" content="http://www.simplesite.com/us-123cafe/">
<meta property="og:title" content="In the Afternoon">
...
Clar...">
<meta property="og:image" content="http://cdn.simplesite.com/i/63/0a/282319406567983715/i282319414584937113._szw1280h1280_.jpg">
<meta property="og:updated_time" content="2017-01-04T04:29:11.8977651+00:00">
...
<meta name="description" content="Maria Bagnarelli&#39;s Cafe - http://www.simplesite.com/us-123cafe/">
        <link rel="stylesheet" type="text/css" href="./Home_files/3746044.design.v25490.css">
<link rel="canonical" href="http://www.simplesite.com/us-123cafe/">
...
<div class="img-simple span3 pull-left">
    <div class="image">
            <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/63/0a/282319406567983715/i282319414584937113._szw1280h1280_.jpg"><img src="./Home_files/i282319414584937113._szw480h1280_.jpg"></a>
    </div>
    </div>
<p><span style="font-family: georgia, palatino; font-size: 24px;"><span style="font-family: georgia, palatino;">Maria's Cosy Cafe</span></span></p> <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
 laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p> <p><span data-mce-mark="1">Claritas est etiam processus dynamicus, qui sequitur
 mutationem consuetudium lectorum. Mirum est notare quam littera gothica</span></p>    </div>
</div>
<div class="section">
    <div class="content">
    ...
    <div class="image">
            <a rel="nofollow" data-ss="imagemodal" data-href="./image/${p.image}"><img src="./image/${p.image}"></a>
    </div>
    </div>
...
<div class="section article">
    ...
    <div class="content">
<p><span style="font-family: times, &#39;times new roman&#39;; font-size: 24px;">Visit my cafe</span></p> <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</p> <p>Gammel Torv, Copenhagen</p> <p>Phone: 12 1234 1234</p>    </div>
</div>
...
<div class="heading wordwrapfix">
    ...
    <li><a id="share-facebook" href="http://www.simplesite.com/us-123cafe#"><i class="icon-facebook-sign"></i><span>Share on Facebook</span></a></li>
    <li><a id="share-twitter" href="http://www.simplesite.com/us-123cafe#"><i class="icon-twitter-sign"></i><span>Share on Twitter</span></a></li>
    <li><a id="share-google-plus" href="http://www.simplesite.com/us-123cafe#"><i class="icon-google-plus-sign"></i><span>Share on Google+</span></a></li>    
</ul></span></div>
            </div>
</div>
            </div>
