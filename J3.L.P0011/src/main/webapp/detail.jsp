<%-- 
    Document   : detail
    Created on : Oct 21, 2019, 8:27:51 AM
    Author     : tri
--%>
        ...
        <div class="section">
            <div class="content">
                ...
                <div class="item">
                    ...
                    <div class="heading">
        <h4>
            <a rel="nofollow" href="View?id=${article.id}"> ${article.title}</a>
        </h4>
                    </div>
                    ...
                    <div class="content">
                        ...
                        <div class="image">
                            <a rel="nofollow" data-ss="imagemodal" data-href="http://cdn.simplesite.com/i/2b/ac/283445309157387307/i283445314544979646._szw1280h1280_.jpg"><img src="./home_files/i283445314544979646._szw480h1280_.jpg"></a>
                        </div>
                        </div>
