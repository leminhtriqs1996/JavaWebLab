...
<div class="content">
    <div class="section">
        <div class="content">
<table class="table" data-year="2015" data-month="11"> <!-- can be bordered, striped, hover, condensed -->
    <thead>
        <tr>
            <th name="month-year" colspan="3">NOVEMBER 2015</th>
    ...
    <tbody>
        <c:forEach var="a" items="${al}" >
            <tr data-id="3232873">
                ...
                <td><i class="icon-thumbs-up"> 123123123</i></td>
